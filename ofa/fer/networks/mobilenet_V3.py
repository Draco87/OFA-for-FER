...
__all__ = ["MobileNetV3", "MobileNetV3FER"]
...
class MobileNetV3(MyNetwork):
    ...
    @staticmethod
    def build_net_via_cfg(cfg, input_channel, last_channel, n_classes=8, dropout_rate=0.3):
        # first conv layer
        ...
        # classifier
        classifier = LinearLayer(last_channel, n_classes, dropout_rate=0.3)
...
class MobileNetV3FER(MobileNetV3):
    def __init__(
        self,
        n_classes=8,  # Changed for AffectNet
        width_mult=0.75,  # Reduced for Jetson
        bn_param=(0.1, 1e-5),
        ...
        input_channel = 16
        last_channel = 960  # Reduced from 1280 for Jetson
        ...
        cfg = {
            ...
            "1": [
                [3, 48, 24, False, "relu", 2, 3],
                [3, 48, 24, False, "relu", 1, 3],
            ],
            "2": [
                [5, 72, 40, True, "relu", 2, 3],
                [5, 72, 40, True, "relu", 1, 3],
            ],
            "3": [
                [3, 120, 80, False, "h_swish", 2, 4],
                [3, 120, 80, False, "h_swish", 1, 4],
            ],
            "4": [
                [3, 240, 112, True, "h_swish", 1, 4],
            ],
            "5": [
                [5, 336, 128, True, "h_swish", 2, 4],
                [5, 336, 128, True, "h_swish", 1, 4],
            ],
        }
